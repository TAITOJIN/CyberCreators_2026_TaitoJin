...
// 初期設定
//---------------------------------------------------
HRESULT SnowEmitter2D::init(const json& inParam)
{
	// 親クラスの処理
...
// 保存
//---------------------------------------------------
void SnowEmitter2D::save(json& outObject) const
{
	// 親クラスの処理
