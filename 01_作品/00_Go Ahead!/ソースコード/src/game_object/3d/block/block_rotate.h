...
// 回転するブロックのクラス
//===================================================
class BlockRotate : public BlockBase
{
public:
	//---------------------------------------------------
	// public メンバ関数宣言
	//---------------------------------------------------
	BlockRotate();
	~BlockRotate() override = default;
	BlockRotate(BlockRotate&& right) noexcept;
	BlockRotate& operator=(BlockRotate&& right) noexcept;
...
private:
	...
	// private メンバ変数宣言
	//---------------------------------------------------
	BlockRotate(const BlockRotate&) = delete;
	void operator=(const BlockRotate&) = delete;
