...
// ムーブコンストラクタ
//---------------------------------------------------
BlockSmoke::BlockSmoke(BlockSmoke&& right) noexcept
...
// 初期設定
//---------------------------------------------------
HRESULT BlockSmoke::init(const json& inParam)
{
	// 親クラスの処理
...
// 保存
//---------------------------------------------------
void BlockSmoke::save(json& outObject) const
{
...
// ムーブ代入演算子
//---------------------------------------------------
BlockSmoke& BlockSmoke::operator=(BlockSmoke&& right) noexcept
{
	if (this != &right)
	{
		// 親クラスの処理
